...
public class GangRemoveExpCommand implements AGangCommand {
    ...
    public void executeCommand(GangsPlugin gangsPlugin, CommandSender sender, String[] args) {
        ...
        gangsPlugin.getMessageManager().sendMessage("removed-exp",sender,amount,gang.getGangName());
    }
