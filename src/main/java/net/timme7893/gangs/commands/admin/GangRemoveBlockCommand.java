...
public class GangRemoveBlockCommand implements AGangCommand {
    ...
    public void executeCommand(GangsPlugin gangsPlugin, CommandSender sender, String[] args) {
        ...
        gangsPlugin.getMessageManager().sendMessage("removed-block",sender,amount,blockType,gang.getGangName());
    }
